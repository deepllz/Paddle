...
class Completer:
    ...
    def complete_forward_annotation(self, serial_main_program=None):
        ...
        self._complete_ops_with_global_mesh(
            serial_main_program, tensor_names, ops
        )
    ...
    def _complete_ops_with_global_mesh(
        ...
        # step3: set the global mesh to ops and tensors
        for op in ops:
        ...
        for i in range(start_op_index, end_op_index + 1):
            ...
            if not m:
                ...
                if (
                    ...
                    # this assign op belong to next segment
